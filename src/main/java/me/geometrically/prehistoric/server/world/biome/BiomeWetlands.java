...
public class BiomeWetlands extends BiomePrehistoric {
    public BiomeWetlands(){
        super(new BiomeProperties("Wetlands").setBaseHeight(-0.2F).setHeightVariation(0.1F).setTemperature(0.8F).setRainfall(0.9F).setWaterColor(5055232));
